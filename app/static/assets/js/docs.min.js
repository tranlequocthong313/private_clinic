          ...
          if (this.hasAnchorJSLink(i[l])) p.push(l);
            ...
            s.replace(/-/g, " "),
              ...
              "left" === this.options.placement
                ...
                : ((f.style.paddingLeft = "0.375em"), i[l].appendChild(f));
          }
      ...
      function (e, t, n) {
        (function (t) {
          ...
          function i(e, t) {
            ...
            if (
              ...
              if (
                ...
                var h =
                  M.vars.cache.themeKeys[
                    0 | (Math.random() * M.vars.cache.themeKeys.length)
                  ];
            ...
            "background" == i
              ...
              : ("img" === o.nodeName.toLowerCase()
                  ...
                  : "object" === o.nodeName.toLowerCase() &&
                    w.setAttr(o, { data: r, type: "image/svg+xml" }),
                l.reRender &&
                  t.setTimeout(function () {
                    ...
                    "img" === o.nodeName.toLowerCase()
                      ? w.setAttr(o, { src: e })
                      : "object" === o.nodeName.toLowerCase() &&
                        w.setAttr(o, { data: e, type: "image/svg+xml" });
                  }, 150)),
            ...
            if (g.lineCount > 1) {
              ...
              for (var C = 0; C < g.words.length; C++) {
                ...
                !e.noWrap &&
                  ...
                  (y.y = E)),
                  T !== !0 &&
                    (m.moveTo(w, 0), (w += g.spaceWidth + k.width), y.add(m));
              }
              if (
                (t(p, y, w, p.properties.leading), p.add(y), "left" === e.align)
              )
            ...
            r.forEach(function (t) {
              (e = M.vars.invisibleImages[t]),
                T(e) &&
                  ...
                  (n.push(e), delete M.vars.invisibleImages[t]);
            }),
          ...
          var g = n(2),
            ...
            O = {
              ...
              addTheme: function (e, t) {
                return (
                  null != e && null != t && (M.settings.themes[e] = t),
              ...
              run: function (e) {
                ...
                (M.vars.preempted = !0),
                  ...
                  M.setup.renderers.join(",").indexOf(n.renderer) === -1 &&
              ...
              return function (r) {
                ...
                if (M.setup.supportsSVG) {
                  ...
                  return (
                    ...
                    { spaceWidth: p, lineCount: u, boundingBox: c, words: g }
                  );
                }
                return !1;
              };
          ...
          for (var D in M.flags)
            M.flags.hasOwnProperty(D) &&
              (M.flags[D].match = function (e) {
          ...
          (M.setup = {
            ...
            (function () {
              ...
              e.getContext &&
                ...
                ((M.setup.renderer = "canvas"), (M.setup.supportsCanvas = !0)),
                document.createElementNS &&
                  document.createElementNS(j, "svg").createSVGRect &&
                  ((M.setup.renderer = "svg"), (M.setup.supportsSVG = !0));
            })(),
            d(),
            g &&
              g(function () {
                M.vars.preempted || O.run(),
                  t.addEventListener
                    ? (t.addEventListener("resize", p, !1),
                      t.addEventListener("orientationchange", p, !1))
                ...
                for (c in t[d])
                  t[d].hasOwnProperty(c) &&
                    ...
                    ("style" === c && "object" == typeof t[d][c]
                      ? (t[0].attr[c] = JSON.stringify(t[d][c], o)
                          .slice(2, -2)
                          .replace(/","/g, ";")
                          .replace(/":"/g, ":")
                          .replace(/\\"/g, "'"))
